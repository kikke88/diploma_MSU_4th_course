...
%\renewcommand{\baselinestretch}{1.1} % расстояние между строками абзаца
...
\begin{document}
	...
	\input{input/1_introduction}
	\input{input/2_problem_statement}
	\input{input/3_overview_of_existing_methods_and_approaches}
	\input{input/4_description_of_the_developed_method}
	\input{input/5_exerimental_verification_of_the_method's_applicability_on_a_supercomputer}
	\input{input/6_conclusion}
	\input{input/7_list_of_references}
